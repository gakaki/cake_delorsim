...
describe('TextSimilarity', () => {
  describe('tokenize', () => {
    ...
    it('should handle case sensitivity', () => {
      ...
      const sensitiveTokens = TextSimilarity.tokenize(text, { ignoreCase: false });
      const insensitiveTokens = TextSimilarity.tokenize(text, { ignoreCase: true });
    ...
    it('should filter tokens by minimum length', () => {
      const text = '这是一个测试文本';
      const tokens1 = TextSimilarity.tokenize(text, { minTokenLength: 1 });
      const tokens2 = TextSimilarity.tokenize(text, { minTokenLength: 2 });
  ...
  describe('createFrequencyVector', () => {
    it('should create correct frequency vector', () => {
      ...
      const vector = TextSimilarity.createFrequencyVector(tokens);
  ...
  describe('cosineSimilarity', () => {
    it('should calculate cosine similarity correctly', () => {
      ...
      const similarity = TextSimilarity.cosineSimilarity(vector1, vector2);
  ...
  describe('analyse', () => {
    it('should analyze text similarity', () => {
      ...
      const result = TextSimilarity.analyse(text1, text2);
    ...
    it('should respect similarity threshold', () => {
      ...
      const resultLowThreshold = TextSimilarity.analyse(text1, text2, { threshold: 0.3 });
      const resultHighThreshold = TextSimilarity.analyse(text1, text2, { threshold: 0.8 });
  ...
  describe('isSimilar', () => {
    it('should quickly check text similarity', () => {
      ...
      const similarResult = TextSimilarity.isSimilar(text1, text2, 0.5);
      const dissimilarResult = TextSimilarity.isSimilar(text1, '完全不同的文本', 0.5);
  ...
  describe('Edge Cases', () => {
    it('should handle empty strings', () => {
      const result = TextSimilarity.analyse('', '');
